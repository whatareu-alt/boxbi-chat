...
var ChatDO = class {
  ...
  async handleSession(ws, username) {
    ws.accept();
    this.sessions.set(ws, { username, subscriptions: /* @__PURE__ */ new Map() });
  ...
  sendStomp(ws, destination, subscriptionId, body) {
    const frame = `MESSAGE
...
// .wrangler/tmp/bundle-vXTYNz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-vXTYNz/middleware-loader.entry.ts
