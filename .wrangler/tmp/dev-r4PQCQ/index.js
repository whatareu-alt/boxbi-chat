...
// .wrangler/tmp/bundle-NxlN3I/strip-cf-connecting-ip-header.js
...
var ChatDO = class {
  ...
  async handleSession(ws, username) {
    ws.accept();
    this.sessions.set(ws, { username, subscriptions: /* @__PURE__ */ new Set() });
...
app.get("/friends/list", async (c) => {
  ...
  return c.json(friends.results.map((r) => r.friend));
});
...
// .wrangler/tmp/bundle-NxlN3I/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-NxlN3I/middleware-loader.entry.ts
