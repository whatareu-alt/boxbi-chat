...
public class EmailService {
    ...
    public void sendPasswordResetEmail(String toEmail, String otp) {
        String subject = "Boxbi Messenger - Password Reset OTP Verification";
        String content = "Hello,\n\n"
                + "We received a request to reset your password on Boxbi Messenger!\n"
                + "Your 6-digit password reset OTP code is: " + otp + "\n\n"
                + "This OTP is valid for 5 minutes. Please enter it on the website to reset your password.\n\n"
        ...
        // Print details clearly to console for easy developer local testing
        System.out.println("----------------------------------------");
        System.out.println("📧 [OUTGOING EMAIL - PASSWORD RESET]");
        System.out.println("Recipient: " + toEmail);
        System.out.println("Subject:   " + subject);
        System.out.println("Content:   \n" + content);
        System.out.println("🔑 [OTP VERIFICATION CODE IS]: " + otp);
